...
b=True
if(b):
    def mdafc(text, doc_lenght): #This function is used to check “Management&#39;s Discussion and Analysis” section
    ...
    def qqdmr(text, doc_lenght): #This function is used to check “Quantitative and Qualitative Disclosures about Market Risk” section
    ...
    def rf(text, doc_lenght): #This function is used to check “Risk factors” section
    ...
    def loadPositive():
        ...
        """
        myfile = open('positive.csv', "r")#Enter your current working directory in full
    ...
    def loadNegative():
        ...
        """
        myfile = open('negative.csv', "r")  #Enter your current working directory in full
    ...
    def loadConstrain():
        ...
        """
        myfile = open('constrain.csv', "r") #Enter your current working directory in full
    ...
    def loadUncertain():
        ...
        """
        myfile = open('uncertain.csv', "r")#Enter your current working directory in full
    ...
    def countCons(cleantext, constrain):
        """
        counts constraint words in cleantext
        """
    ...
    def countUn(cleantext, uncertain):
        """
        counts uncertain words in cleantext
        """
...
loc = ('cik_list.xlsx') #Enter your current working directory in full
locw = ('OutputDataStructure.xlsx')#Enter your current working directory in location
# To open Workbook
wb = xlrd.open_workbook(loc)
sheet = wb.sheet_by_index(0)
workbook = xlsxwriter.Workbook('Output_Solution.xlsx')#Enter your current working directory location
sheet1 = workbook.add_worksheet()
sys.setrecursionlimit(100000)
# For row 0 and column 0
for i in range(1, 153): #153 for the number of rows present in column 5 with url
    ...
    positive = loadPositive() #loads a reference to positive words array
    negative = loadNegative() #loads a reference to negative words array
    constrain = loadConstrain()#loads a reference to Constraining words array
    uncertain = loadUncertain()#loads a reference to Uncertain words array
    text1=cleanText(text)

    total_cons = countCons(text1, constrain)
    #considering all the cases possible
    if mda != 0 and qqd == 0 and rfs == 0:
        ...
        if(qqd_word_count!=0):
            ...
            qd_percentage_complex_words = (qqd_complex_words/qqd_word_count)*100
            qd_fog_idex = 0.4*(qqd_avg_sentence_lenght +
                            qd_percentage_complex_words)
